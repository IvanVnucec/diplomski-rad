...
while(True) {
  ...
  čekaj_100_milisekundi();
            ...
            \subsubsection{Dretva za komunikaciju}{
                ...
                Obratimo pažnju kako svaka komanda da bi je satelit primio, mora završavati s ASCII znakom \texttt{\textbackslash n} odnosno novim redom \engl{new line, line feed - LF}. Komunikacijska dretva će ignorirati bilo koju drugu komandu koja nije opisana u tablici \ref{tbl:lista_komandi}.
...
\kljucnerijeci{TODO, TODO, TODO}
\end{sazetak}

\engtitle{Attitude Determination and Control System software}
\begin{abstract}{
