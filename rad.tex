...
\chapter{Eksperimentalna verifikacija ADCS sustava}{
    ...
    \section{Određivanje parametara}{
        \subsection{Kinematički model}{
            ...
            Ako sustavu u mirovanju pošaljemo komandu za promjenu DC zamašnjaka sa 0\% na 50\% (vidi popis komandi \ref{TODO}), odziv sustava na dvije takve pobude prikazan je na slici \ref{fig:step_response}. Primjetimo kako oko 20 sekunde kutna brzina počinje blago padati. Razlog tomu su blage nepravilnosti zračnog ležaja koje uzrokuju parazitni moment i tako usporavaju satelit. Modeliranje parazitnog momenta nismo uzimali u obzir radi jednostavnosti jednadžbi. 
